...
CDataTransformer_Multiply2D::CDataTransformer_Multiply2D(QString datas_lst_in_str,
...
*/
void CDataTransformer_Multiply2D::data_updated()
{
    double new_val;
 ...
 */
QString CDataTransformer_Multiply2D::getShortAlgoName()
{
   return "multiply2D";
}
 ...
 */
QString CDataTransformer_Multiply2D::getFormula()
{
 ...
 */
QString CDataTransformer_Multiply2D::getHelp()
{
   return "Multiplie 2 données entre elles";
}
 ...
 * \return le template
 */
QString CDataTransformer_Multiply2D::getParamsTemplate()
{
